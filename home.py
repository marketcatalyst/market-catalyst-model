...
# --- 4. CLEAN OPERATIONAL REGISTRY DATA MATRIX ---
# All generic placeholder dross has been purged. 
...
# --- 5. DYNAMIC PATH DISCOVERY RESOLUTION ---
...
# --- 6. COMPILING THE REFINED SIDEBAR GRAPH ---
try:
    pg = st.navigation(
        {
            "Core Console": [
