...
# Native microphone recording widget mapping directly into session cache streams
audio_data = st.audio_input("Record voice instruction input sequence:", label_visibility="collapsed")

# --- MULTIMODAL PARSING & PARSER API CORE INFRASTRUCTURE ---
if audio_data is not None:
    ...
    with st.spinner("Analyzing audio frequencies and mapping lexical accounting intents..."):
        try:
            # Extract raw byte payload array from front-end component stream
            audio_bytes = audio_data.read()
            
            # Simulated token parsing output generated by your underlying Gemini integration logic
            ...
            # Merge parsed payload data directly into active spreadsheet frames
...
# ==========================================
# Split header alignment grid to position the interactive popover documentation on the right hand side
...
with col_tb_pop:
    # 💡 ADDED: "What, When & Why" popover drawer to maximize onboarding clarity on your true ingestion layout page
